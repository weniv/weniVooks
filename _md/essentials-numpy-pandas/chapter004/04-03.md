...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df_main.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.Explicit_Index.png )
:::
...
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.Implicit_Index.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.pivot.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/np.melt.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.loc.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.iloc.png )
:::
### 3.3 at를 사용한 데이터 접근
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/update_usa.png )
:::
### 3.4 iat를 사용한 데이터 접근
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.iat.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/df.multi.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/연간소비량.png )
:::
### 4.1.2 조건을 사용한 행 조회:
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/연간소비량5.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/브라질.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/3_4.png )
:::
### 4.1.5 특정 조건을 만족하는 행에서 특정 열만 조회

```python
# 카페 수가 50,000개 이상인 국가의 이름과 카페 수 조회
print(df.loc[df['카페_수'] >= 20000, ['국가', '카페_수']])
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/2000+.png )
:::
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/describe.png )
:::
### 5.2  그룹별 연산
...
```
:::div{.box}
![피그잼](/images/essentials-numpy-pandas/chapter04/groupby.png )
:::
