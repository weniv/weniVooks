...
---
# 1. 게시물 생성과 삭제
Django의 ORM(Object-Relational Mapping)을 사용하여 게시판의 기본 기능인 **게시물 생성과 삭제**를 구현해보겠습니다. 이는 CRUD(Create, Read, Update, Delete) 작업 중 Create와 Delete에 해당합니다. 먼저 blog 앱의 urls.py와 views.py 파일을 수정하여 게시물 생성과 삭제 기능을 추가해 봅시다.
