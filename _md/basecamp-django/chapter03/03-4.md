...
| 데이터베이스 관계도 | ERD | 
| ------------------------------------------ | ------------------------------------------ |
| ![](/images/basecamp-django/chapter03/04-데이터베이스관계도.png) | ![](/images/basecamp-django/chapter03/04-ERD.png) |
...
| ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| ![](/images/basecamp-django/chapter03/04-일대다.png) | ![](/images/basecamp-django/chapter03/04-다대다.png) | ![](/images/basecamp-django/chapter03/04-일대일.png) |

지금까지 우리는 Django 프로젝트의 기본 구조를 설정하고, 데이터베이스의 기초 개념과 모델 관계 유형에 대해 학습했습니다.
이러한 기본 지식을 바탕으로, 다음 섹션에서는 일대다(1 : N)관계와 다대다(N : M)관계를 실제로 구현하는 방법에 대해 알아보겠습니다. 이를 통해 데이터베이스 이론이 실제 Django 모델에서 어떻게 적용되는지 이해할 수 있을 것입니다.