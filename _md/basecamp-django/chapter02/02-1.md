...
:::div{.callout}
위의 '개발 환경 설정'과 'Django 프로젝트 생성' 과정은 모든 Django 프로젝트의 **기초** 입니다. 이후 실습에서는 이 과정을 반복하지 않으므로, 새로운 프로젝트를 시작할 때마다 이 단계들을 **먼저** 수행해주세요. 환경 설정이 완료된 후 실습을 진행하시면 됩니다.
:::
...
2. `templates/main` 폴더에 `index.html`파일을 추가하고, 아래 내용을 입력합니다.
