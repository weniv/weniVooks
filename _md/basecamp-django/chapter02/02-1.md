...
:::div{.callout}
위의 '개발 환경 설정'과 'Django 프로젝트 생성' 과정은 모든 Django 프로젝트의 **기초** 입니다. 이후 실습에서는 이 과정을 반복하지 않으므로, 새로운 프로젝트를 시작할 때마다 이 단계들을 **먼저** 수행해 주세요. 환경 설정이 완료된 후 실습을 진행하시면 됩니다. 더 자세한 내용은 1장의 1.3 Django 설치 및 프로젝트 생성을 참고해 주세요.
