...
JavaScript는 넷스케이프사에서 개발되었지만, ECMA International이라는 기구에 의해 표준화되었습니다. 표준화 당시에는 다양한 브라우저에서 이미 작동 중인 JavaScript를 통합하여 표준을 정리하였습니다. JavaScript의 표준은 **ECMAScript(ECMA-262)** 입니다. 2015년의 ES6를 기준으로 매년 새 버전으로 개정하고 있습니다.
