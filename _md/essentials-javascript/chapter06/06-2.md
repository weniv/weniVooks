...
각 속성의 기본값을 설정할 수 있습니다. 기본값을 설정하면, 해당 속성이 없을 때 기본값이 할당됩니다. 기본값을 설정할 때는 `undefined`를 사용해야 합니다.
...
속성의 기본값을 설정할 수 있습니다. 기본값을 설정하면, 해당 속성이 없을 때 기본값이 할당됩니다. 기본값을 설정할 때는 `undefined`를 사용해야 합니다.
...
함수에 인자가 없는 경우에는 `undefined`가 할당되기 때문에 오류가 발생합니다. `undefined`는 객체가 아니기 때문에 구조 분해 할당을 할 수 없습니다. 이를 방지하기 위해 빈 객체를 기본값으로 설정할 수 있습니다.
