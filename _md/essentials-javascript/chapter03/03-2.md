...
:::div{.callout}
**이스케이프 문자**  
문자열 안에서 따옴표나 줄바꿈을 표현하기위해서는 이스케이프 문자를 사용합니다. 다음 문자열을 출력해보세요.
...
![Untitled](/images/essentials-javascriptchapter03/text.png)
...
![Untitled](/images/essentials-javascriptchapter03/Untitled%201.png)
