...
웹 페이지에 댓글 기능 챗봇 기능을 추가하여 매력적인 요소를 더할 수 있습니다. 우선 아래 사이트의 가입을 하신 다음, 적용하기 위한 단계를 따라와 주세요!

## 3.1 Tawk

::img{width="300" alt="Tawk Logo" src="/images/basecamp-react/chapter02-9/chapter02-9-4.png"}

Tawk는 웹페이지 개발 시, 개인이 무료로 챗봇 기능을 추가할 수 있는 사이트입니다.

1. 로그인 후, Administration 을 눌러 주세요.

::img{width="400" alt="Administration" src="/images/basecamp-react/chapter02-9/chapter02-9-5.png"}

2. Channels을 눌러 Chat Widget 에 들어가 주세요.

::img{width="300" alt="Chat Widget" src="/images/basecamp-react/chapter02-9/chapter02-9-6.png"}

3. 우측 Widget Code 를 복사해 주세요.

::img{width="400" alt="Widget Code" src="/images/basecamp-react/chapter02-9/chapter02-9-7.png"}

4. 챗봇을 넣고자 하는 페이지에 코드를 넣어 주세요.

::img{width="500" alt="Code" src="/images/basecamp-react/chapter02-9/chapter02-9-8.png"}

5. 실시간 챗봇 기능 적용 완료!

::img{width="600" alt="Chatbot Applying" src="/images/basecamp-react/chapter02-9/chapter02-9-9.png"}

자, 이제 우리는 챗봇 기능을 사용할 수 있게 되었습니다.
