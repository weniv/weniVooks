...
이전 버전과 이후 버전들의 포인터가 어떻게 변했는지는 [유로 파이썬](https://www.youtube.com/watch?v=xKk7IXm0XO0)에 잘 나와 있습니다. 3.11버전에 가장 눈여겨 볼만한 변화는 포인터의 간소화 입니다. 이전에는 Value에 접근하기 위해 3개의 포인터를 거쳐야 했지만 3.11버전에서는 2개의 포인터만 거치게 되었습니다. 이로 인해 메모리 사용량이 줄어들고 성능이 향상되었습니다. 
