...
title: 05.3 GitHub으로 협업 프로젝트하기 - GitHub을 모르는 동료와 PR 반복훈련
date: 2024-5-4
---

- 해당 자료는 제주코딩베이스캠프의 유튜브 채널에서 제공되는 영상입니다.
    - 링크: https://youtu.be/1e9MaoflQ3A
- **대상**
    - **팀 프로젝트 투입 전 팀장, 팀원**
...
- **상세 영상**
    - 협업에 관한 더 상세한 영상: https://youtu.be/6sBNPvxjyt0
    - 무료 GitHub 강의: https://inf.run/HQk6
- (팀장 + 팀원) 팀 편성 후 프로세스
