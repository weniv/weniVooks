...
w 서술자는 이미지의 원본 넓이를 브라우저에게 알려줍니다. w 서술자가 적용되면 이미지 크기는 기본적으로 뷰포트의 100%를 차지하게 되며, width, sizes 등의 속성으로 이를 변경할 수 있습니다. 주의할 점은 w 서술자를 사용한 경우 src 속성을 무시한다는 것입니다.
