...
CSS는 정답이 하나가 아니라 여러 가지 방법들이 있어요. 아래 예제를 보면서 CSS를 작성하는 다양한 방법을 알아보겠습니다.
...
1. 개별로 인라인 스타일 적용하기: CSS를 파일로 작성하지 않고 HTML 태그 내에 작성합니다. 복잡도 상승, 유지보수, CSS의 철학 등을 이유로 권하지 않습니다.
...
2. 태그 선택자 적용하기: 태그를 선택하여 꾸몄습니다. CSS 탭을 눌러보세요. 이렇게 작성하면 모든 태그에 스타일이 적용됩니다.
...
3. 그룹 선택자(`,`)로 적용하기: 여러 태그를 선택하여 한 번에 스타일을 적용할 수 있습니다.
...
4. 상속 이용하기: 상속을 이용하여 부모 요소에 스타일을 적용하면 자식 요소에도 적용됩니다.
...
이처럼 CSS를 적용시키는 방법에는 여러가지 방법이 있습니다. 정답이 하나가 아니라 여러 가지 방법이 있기 때문에 어떤 방법이 간편하며 효율적이고 가독성이 높은지 다양한 경험을 쌓을 필요가 있습니다.
