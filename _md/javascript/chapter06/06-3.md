...
위 코드의 매개변수에는 구조 분해 할당을 이용해서 다음과 같이 인자값이 할당됩니다. 객체를 매개변수로 사용하면 순서와 상관없이 key 값으로 할당됩니다. 배열을 매개변수로 사용할 때는 순서에 유의해야 합니다.
...
- 나머지 문법: 함수의 마지막 매개변수나 구조 분해 할당에서 사용합니다.
