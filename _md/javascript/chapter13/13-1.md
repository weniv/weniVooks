...
:::figure
::img{width="600" alt="추상화된 황소" src="/images/javascript/chapter13/01-1.png"}
::figcaption[이 그림은 무엇을 표현한 것일까요?]
:::

:::div{.callout}
**피카소의 추상화 과정**
![](/images/javascript/chapter13/01-4.png)
:::
...
:::img{width="400px" alt="" src="/images/javascript/chapter13/01-2.png"}
:::img{width="400px" alt="" src="/images/javascript/chapter13/01-3.png"}
