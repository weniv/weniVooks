export const DEFAULT_PATH = 'essentials-java';
export const TITLE = 'Java 에센셜';
export const DESCRIPTION = 'Java 프로그래밍 언어의 기초 개념을 다루는 학습 가이드입니다.';
